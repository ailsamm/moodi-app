...
const STORE = {
    ...
    mood_logs: [
        ...
        {id: 4, user_id: 1, mood: 'calm', start: moment("06-11-2020", 'MM-DD-YYYY'), end: moment("06-11-2020", 'MM-DD-YYYY'), title: "\xA0", activities: ['clean', 'read'], sleepHours: 2, notes: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum elit.'},
